@extends('layouts.manage', ['title' => 'Create User'])

@section('content')
    <h1 class="text-primary-500 text-2xl mb-6">Create User</h1>
    ...
    <form action="{{ route('manage.users.store') }}" method="POST">
        ...
        <button class="mt-6 inline-block text-white bg-primary-500 py-3 px-4 rounded hover:bg-primary-600 transition duration-200 outline-none focus:bg-primary-600 focus:outline-none">Create User</button>
    </form>
@endsection
